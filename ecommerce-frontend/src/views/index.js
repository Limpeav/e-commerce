...
export { default as AdminLogin } from './auth/pages/AdminLogin';
...
export { default as OrderSuccess } from './cart/Success';
...
export { default as OrderTracking } from './orders/Tracking';
