...
// Custom hook for admin controller
export const useAdminController = () => {
  const { user } = useAuth()

  const validateAccess = () => {
    return AdminController.validateAdminAccess(user)
  }
  ...
  return {
    ...
    updateOrderStatus: AdminController.updateOrderStatus,
    createProduct: AdminController.createProduct,
    ...
    getSalesAnalytics: AdminController.getSalesAnalytics,
    getInventoryReport: AdminController.getInventoryReport,
    exportData: AdminController.exportData,
    formatCurrency: AdminController.formatCurrency,
    formatDate: AdminController.formatDate,
    calculateGrowth: AdminController.calculateGrowth,
  }
}
