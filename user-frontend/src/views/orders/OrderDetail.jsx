            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-text-muted">
                  {t("orderDetail.qty")} {item.quantity} · <Price amount={item.price} exchangeRate={order.exchangeRateAtOrder} />
          ...
          <div className="space-y-2 text-sm text-text-muted">
            <div className="flex justify-between">
              ...
              <Price
                ...
                exchangeRate={order.exchangeRateAtOrder}
            ...
            <div className="flex justify-between">
              ...
              <span className="font-semibold text-text-main">
                  {order.shippingPrice > 0
                    ? <Price amount={order.shippingPrice} exchangeRate={order.exchangeRateAtOrder} usdClassName="text-text-main" />
                  : t("orderDetail.free")}
              </span>
            </div>
            {order.taxPrice > 0 && (
              <div className="flex justify-between">
                ...
                <Price amount={order.taxPrice} exchangeRate={order.exchangeRateAtOrder} className="font-semibold text-text-main" usdClassName="text-text-main" />
              </div>
            )}
            ...
            <div className="flex justify-between text-base">
              ...
              <Price amount={order.totalPrice} exchangeRate={order.exchangeRateAtOrder} className="font-bold text-text-main" usdClassName="text-text-main" />
            </div>
          </div>
        </div>
