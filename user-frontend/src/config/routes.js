...
export const additionalRoutes = [
  ...
  { path: "/customer/privacy", component: "Privacy" },
  { path: "/terms", component: "Terms" },
  { path: "/customer/terms", component: "Terms" },
  { path: "/about", component: "About" },
  { path: "/customer/about", component: "About" },
  { path: "/contact", component: "Contact" },
  { path: "/customer/contact", component: "Contact" },
  { path: "/knowledge-base", component: "KnowledgeBase" },
  { path: "/customer/knowledge-base", component: "KnowledgeBase" },
  { path: "/location", component: "Location" },
  { path: "/customer/location", component: "Location" },
  { path: "/translate", component: "RealtimeTranslate" },
  { path: "/customer/translate", component: "RealtimeTranslate" },
