            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
              <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                ...
                <div className="flex items-baseline gap-2">
                  <Price amount={stats.revenue || 0} className="text-3xl font-bold text-blue-600" usdClassName="text-blue-600" showKHR={false} />
                  {stats.revenueKHR > 0 && (
                    <span className="text-lg font-bold text-blue-500/70">
                      (≈ {Math.round(stats.revenueKHR).toLocaleString()}៛)
                    </span>
                  )}
                </div>
              </div>
