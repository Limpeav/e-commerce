                            ...
                            <div>
                                ...
                                {isDelivery && (
                                    <p className="mt-1 text-sm text-[var(--color-text-muted)]">
                                        {customerName} · <Price amount={displayedTotal} exchangeRate={order.exchangeRateAtOrder} />
                                    </p>
                                )}
                            </div>
                        </div>
                                    ...
                                    {order.orderItems.map((item, index) => (
                                        ...
                                        >
                                            ...
                                            <div className="min-w-0 self-center">
                                                ...
                                                <p className="mt-1 text-sm text-[var(--color-text-muted)]">
                                                    Quantity {item.quantity} · <Price amount={item.price} exchangeRate={order.exchangeRateAtOrder} /> each
                                            ...
                                            <div className="col-span-2 flex items-center justify-between rounded-lg bg-[var(--color-surface-soft)] px-4 py-3 sm:col-span-1 sm:block sm:self-center sm:bg-transparent sm:px-0 sm:py-0 sm:text-right">
                                                ...
                                                <p className="font-bold text-[var(--color-text-main)]">
                                                    <Price amount={item.price * item.quantity} exchangeRate={order.exchangeRateAtOrder} />
                                                </p>
                                            </div>
                                        </div>
                                    ))}
                                ...
                                <div className="space-y-3 text-sm text-[var(--color-text-muted)]">
                                    ...
                                    <div className="mt-4 space-y-3 border-t border-[var(--color-border)] pt-4">
                                        <div className="flex justify-between gap-4">
                                            <span>Subtotal:</span>
                                            <Price amount={subtotal} exchangeRate={order.exchangeRateAtOrder} className="font-bold text-[var(--color-text-main)]" usdClassName="text-[var(--color-text-main)]" />
                                        </div>
                                        <div className="flex justify-between gap-4">
                                            <span>Delivery Fee:</span>
                                            <Price amount={deliveryFee} exchangeRate={order.exchangeRateAtOrder} className="font-bold text-[var(--color-text-main)]" usdClassName="text-[var(--color-text-main)]" />
                                        </div>
                                        <div className="flex justify-between gap-4">
                                            <span>Tax:</span>
                                            <Price amount={taxPrice} exchangeRate={order.exchangeRateAtOrder} className="font-bold text-[var(--color-text-main)]" usdClassName="text-[var(--color-text-main)]" />
                                        </div>
                                        <div className="mt-4 flex justify-between gap-4 rounded-lg bg-[var(--color-surface-soft)] p-4 text-lg font-bold text-[var(--color-text-main)]">
                                            <span>Total:</span>
                                            <Price amount={displayedTotal} exchangeRate={order.exchangeRateAtOrder} className="text-[var(--color-text-main)]" usdClassName="text-[var(--color-text-main)]" />
                                        </div>
                                    </div>
                                </div>
                            </section>
