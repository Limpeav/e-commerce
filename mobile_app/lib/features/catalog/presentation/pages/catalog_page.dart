      ...
      body: GestureDetector(
        ...
        child: BlocBuilder<ProductBloc, ProductState>(
          builder: (context, productState) {
            ...
            return Column(
              children: [
                // Search Input & Discovery Region (Unfocuses & disappears when tapping outside)
                TapRegion(
                  groupId: 'catalog_search_region',
                  onTapOutside: (_) {
                    if (_searchFocusNode.hasFocus) {
                      _searchFocusNode.unfocus();
                      if (mounted) {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Recent Searches & Trending Tags Panel (shown on focus or when empty, disappears on tap outside)
                      AnimatedSize(
                        duration: const Duration(milliseconds: 200),
                        curve: Curves.easeInOut,
                        child: (_isSearchFocused && _searchController.text.isEmpty)
