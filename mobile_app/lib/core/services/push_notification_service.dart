  ...
  void notifyOrderStatusChange({
    ...
    switch (newStatus) {
      ...
      case OrderStatus.delivered:
        final orderCode = order.displayOrderCode.isNotEmpty ? order.displayOrderCode : order.id;
        title = '🎉 Order Delivered - Rate Your Products';
        message = 'Your order $orderCode has been delivered! Please rate the products you received.';
        break;
