...
import 'package:mobile_app/core/constants/category_assets.dart';
...
import 'package:mobile_app/features/cart/presentation/bloc/cart_event.dart';
import 'package:mobile_app/features/orders/presentation/bloc/order_bloc.dart';
import 'package:mobile_app/features/orders/presentation/bloc/order_event.dart';
import 'package:mobile_app/features/products/presentation/bloc/product_bloc.dart';
import 'package:mobile_app/features/products/presentation/bloc/product_event.dart';
...
import 'package:mobile_app/features/wishlist/presentation/bloc/wishlist_event.dart';
...
import 'package:mobile_app/features/auth/presentation/pages/verify_account_page.dart';
import 'package:mobile_app/features/checkout/presentation/pages/checkout_page.dart';
import 'package:mobile_app/features/checkout/presentation/widgets/map_location_picker_sheet.dart';
import 'package:mobile_app/features/notifications/presentation/bloc/notification_cubit.dart';
import 'package:mobile_app/features/orders/presentation/pages/orders_page.dart';
import 'package:mobile_app/features/orders/presentation/pages/pending_reviews_page.dart';
import 'package:mobile_app/features/products/data/datasources/product_remote_datasource.dart';
...
void main() {
  ...
  group('Catalog & FilterModal Tests', () {
    ...
    testWidgets('PendingReviewsPage renders thank you page with animation when ratings are complete', (WidgetTester tester) async {
      await tester.pumpWidget(
        _buildTestApp(
    ...
    testWidgets('PendingReviewsPage renders 5 filled stars by default and only one bottom submit button',
      ...
      // Verify Required Ratings appbar is present without back button
