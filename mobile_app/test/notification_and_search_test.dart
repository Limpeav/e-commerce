...
import 'package:mobile_app/core/models/notification_item.dart';
import 'package:mobile_app/core/models/order.dart';
import 'package:mobile_app/core/services/search_history_service.dart';
import 'package:mobile_app/features/catalog/presentation/pages/catalog_page.dart';
import 'package:mobile_app/features/notifications/presentation/pages/notification_center_page.dart';
import 'package:mobile_app/features/orders/presentation/pages/order_tracking_page.dart';
...
void main() {
  ...
  group('NotificationCenterPage & Live Tracking Widget Tests', () {
    ...
    testWidgets('CatalogPage hides Trending Searches when tapping outside search field', (tester) async {
      await tester.pumpWidget(_buildTestApp(child: const CatalogPage(focusSearchOnOpen: true)));
      await tester.pump();
      await tester.pump(const Duration(milliseconds: 300));
      ...
      // Tap outside the search field (e.g. on products or background below)
